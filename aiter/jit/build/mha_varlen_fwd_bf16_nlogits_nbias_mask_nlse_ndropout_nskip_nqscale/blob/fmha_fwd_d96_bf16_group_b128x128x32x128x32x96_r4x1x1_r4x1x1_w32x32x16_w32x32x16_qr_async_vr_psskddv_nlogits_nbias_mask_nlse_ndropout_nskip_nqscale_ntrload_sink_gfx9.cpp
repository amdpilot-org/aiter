...
float fmha_fwd_<trait, ck_tile::gfx9_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d96_bf16_group_b128x128x32x128x32x96_r4x1x1_r4x1x1_w32x32x16_w32x32x16_qr_async_vr_psskddv_nlogits_nbias_mask_nlse_ndropout_nskip_nqscale_ntrload_sink" << std::flush;
