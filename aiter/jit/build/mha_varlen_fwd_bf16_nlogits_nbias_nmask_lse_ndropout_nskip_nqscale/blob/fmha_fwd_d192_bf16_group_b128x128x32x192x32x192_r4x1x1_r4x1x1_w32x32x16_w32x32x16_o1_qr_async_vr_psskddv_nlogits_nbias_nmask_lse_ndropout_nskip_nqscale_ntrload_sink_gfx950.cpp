...
float fmha_fwd_<trait, ck_tile::gfx950_t>(const ck_tile::stream_config& s, fmha_fwd_args a)
{
    ...
    if(s.log_level_ > 0)
        std::cout << ", fmha_fwd_d192_bf16_group_b128x128x32x192x32x192_r4x1x1_r4x1x1_w32x32x16_w32x32x16_o1_qr_async_vr_psskddv_nlogits_nbias_nmask_lse_ndropout_nskip_nqscale_ntrload_sink" << std::flush;
